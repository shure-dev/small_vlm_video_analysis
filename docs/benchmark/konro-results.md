...
ガスコンロの始業前点検を撮影した同一の16フレームに対し、ローカルVLM 15モデルの回答を人手アノテーションで評価しました。
...
| Cosmos-Reason1-7B | 0.59 | 81% | 44% | 100% | 100% | 62% | 81% | 100% |
...
| Molmo-7B | 0.30 | 68% | 50% | 100% | 31% | 31% | 94% | 100% |
...
人手アノテーションは [`datasets/konro_inspection/annotations/human-v001/konro_inspection.json`](../../datasets/konro_inspection/annotations/human-v001/konro_inspection.json) です。
